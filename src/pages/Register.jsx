            ...
            <div className="col-lg-7">
              <div className="p-5">
                ...
                <form className="user">
                  ...
                  <hr />
                  <Link to="/" className="btn btn-google bg-danger btn-user col-12 mb-3">
                    <i className="fab fa-google fa-fw"></i> Register with Google
                  </Link>
                  <Link to="/" className="btn btn-facebook btn-user bg-primary col-12">
                    <i className="fab fa-facebook-f fa-fw"></i> Register with Facebook
                  </Link>
                </form>
                <hr />
                <div className="text-center">
                  <Link className="small" to="/forgot_password">Forgot Password?</Link>
                </div>
                <div className="text-center">
