  ...
  return (<>
   ...
   <div className="card shadow mb-4 text-start">
        ...
        <div className="card-body">
          <h4 className="small font-weight-bold">Server Migration <span className="float-end">20%</span></h4>
          ...
          <h4 className="small font-weight-bold">Sales Tracking <span className="float-end">40%</span></h4>
          <div className="progress mb-4">
          ...
          <h4 className="small font-weight-bold">Customer Database <span className="float-end">60%</span></h4>
          <div className="progress mb-4">
            <div className="progress-bar" role="progressbar" style={{ width: '60%' }} aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
          <h4 className="small font-weight-bold">Payout Details <span className="float-end">80%</span></h4>
          <div className="progress mb-4">
          ...
          <h4 className="small font-weight-bold">Account Setup <span className="float-end">Complete!</span></h4>
