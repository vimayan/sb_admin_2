    ...
    return (
      <div className="card shadow mb-4 text-start">
        ...
        <div className="card-body">
          <p>SB Admin 2 makes extensive use of Bootstrap 5 utility classes in order to reduce CSS bloat and poor page performance. Custom CSS classes are used to create custom components and custom utility classes.</p>
