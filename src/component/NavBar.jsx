...
import Prof from "../assets/img/undraw_profile.svg";
import Img1 from "../assets/img/undraw_profile_1.svg";
import Img2 from "../assets/img/undraw_profile_2.svg";
import Img3 from "../assets/img/undraw_profile_3.svg";
import LogoutModal from "./LogoutModel";
import MenuContext from "../context/MenuContext";

const TopBar = () => {
  const menu_context = useContext(MenuContext);
  const {toggled} = menu_context;
  return (
    <>
      ...
      <ul className="navbar-nav ms-auto">
        ...
        <li className="nav-item dropdown no-arrow mx-1">
          ...
          >
            ...
            {/* Counter - Alerts */}
            <span className="badge bg-danger rounded-4 badge-counter">3+</span>
          </a>
          {/* Dropdown - Alerts */}
          <div
        ...
        <li className="nav-item dropdown no-arrow mx-1">
          ...
          >
            ...
            {/* Counter - Messages */}
            <span className="badge bg-danger rounded-circle badge-counter">
              7
            </span>
          </a>
          {/* Dropdown - Messages */}
